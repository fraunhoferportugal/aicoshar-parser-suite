...
Marília Barandas, Ana Cravidão Pereira, Carolina Carvalho, Duarte Folgado, Ricardo Santos, Maria Russo, Vânia Guimarães, Hugo Gamboa, Inês Sousa\
Date: April 2026\
...
If you use the aicoshar-parser-suite tool, please cite the following work, which provides information about the AICOS-HAR dataset and the results of baseline experiments including some of the public datasets supported by aicoshar-parser-suite.

{CITATION}

## Description

The aicoshar-parser-suite is a repository that provides a tool for automatic download and structure harmonization of 20 public human activity recognition datasets. The public datasets were harmonized according to the AICOS-HAR dataset structure and content, meaning only activities and sensors present in AICOS-HAR dataset were kept. However, most parsers are easily adaptable.
